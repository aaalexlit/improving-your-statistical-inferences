...
st.page_link("pages/6_P_Value_Over_Time.py", label="P‑Value Over Time", icon="📊")
st.page_link("pages/7_Optional_Stopping.py", label="Optional Stopping Simulation", icon="🔍")
